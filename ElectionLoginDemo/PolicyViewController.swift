...
class PolicyViewController: myViewController, UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        print("我正在秀policyWeb網頁\(self.appdelegate.generic.policyWeb)")
        self.policyWebView.loadRequest(
            URLRequest(url:
                URL(string: self.appdelegate.generic.policyWeb)!,
