//
//  SetDesktopViewController.swift
//  ElectionLoginDemo
//
//  Created by EZoneLai Lai on 2017/8/16.
//  Copyright © 2017年 EZoneLai. All rights reserved.
//

import UIKit

class SetDesktopViewController: myViewController,UIScrollViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate, URLSessionTaskDelegate, URLSessionDataDelegate, URLSessionDelegate, Reaction {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        titleView.image = self.appdelegate.desktopWallpaperImage
